  ...
  var serie = g.selectAll(".serie")
    ...
    .enter().append("g")
      ...
      .on("mousemove", function(d) {
        ...
        tooltip.select("text").text("percentage number and absolute number");
      });
  ...
  var serie = g2.selectAll(".serie")
    ...
    .enter().append("g")
      ...
      .on("mousemove", function(d) {
        ...
        tooltip2.select("text").text("percentage number and absolute number");
      });
  ...
  var serie = g3.selectAll(".serie")
    ...
    .enter().append("g")
      ...
      .on("mousemove", function(d) {
        ...
        tooltip3.select("text").text("percentage number and absolute number");
      });
