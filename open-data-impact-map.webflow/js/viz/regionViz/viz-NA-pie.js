...
var svg = d3.select("#viz-container1").append("svg")
    .attr("id", "byType")
    .attr("class", "pieSvg")
    .attr("width", width)
    .attr("height", height)
...
d3.csv("viz-data/data-LAC-pie1.csv", type, function(error, data) {
...
var svg2 = d3.select("#viz-container1").append("svg")
    .attr("id", "bySize")
    .attr("class", "pieSvg")
    .attr("width", width)
    .attr("height", height)
...
d3.csv("viz-data/data-LAC-pie2.csv", type, function(error, data) {
  if (error) throw error;
...
var svg3 = d3.select("#viz-container1").append("svg")
     .attr("id", "byAge")
     .attr("class", "pieSvg")
    .attr("width", width)
    .attr("height", height)
...
d3.csv("viz-data/data-LAC-pie3.csv", type, function(error, data) {
  if (error) throw error;
